...
// Ported verbatim from reference/sim/apps/sim/tailwind.config.ts, with content
// globs adapted to Goliath's src/ layout (vendored @sim/emcn and
// @sim/workflow-renderer live under src/vendor, covered by ./src/**).
export default {
